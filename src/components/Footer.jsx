  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        <div>
          <h4 className="font-semibold text-lg mb-4 text-gray-100">Docs</h4>
          <ul>
            <li>
              <a
        ...
        <div>
          <h4 className="font-semibold text-lg mb-4 text-gray-100">GitHub</h4>
          <ul>
            <li>
              <a
        ...
        <div>
          <h4 className="font-semibold text-lg mb-4 text-gray-100">License</h4>
          <ul>
            <li>
              <a
                href="/license"
